...
class OikiriStateIndex(baseobj):
    ...
    oikiri_state = colobj(
        intobj,
        fkyobj('train_oikiri.oikiri_state'),
        primary_key=True)
    index = colobj(intobj)
...
class TrainCourseCodeIndex(baseobj):
    ...
    train_course_code = colobj(
        strobj,
        fkyobj('train_oikiri.train_course_code'),
        primary_key=True)
    index = colobj(intobj)
